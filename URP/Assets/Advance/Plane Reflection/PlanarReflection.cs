...
public class PlanarReflection : MonoBehaviour
{
    ...
    private void RenderReflection(ScriptableRenderContext context, Camera sourceCam)
    {
        if (mReflectionCamera == null)
        {
            ...
            //             {
            // #if UNITY_EDITOR
            //                 ScriptableRendererData planarReflectionRender = PipelineUtilities.GetRenderer<UniversalRendererData>(planarReflectionRender_Str, nameof(UniversalRendererData));

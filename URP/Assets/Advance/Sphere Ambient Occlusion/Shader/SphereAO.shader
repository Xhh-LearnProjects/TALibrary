Shader "TALibrary/SphereAO"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            TEXTURE2D_FLOAT(_MaskDepthRT);      SAMPLER(sampler_MaskDepthRT);  //这一个Depth  是扣除了不需要的地方
            ...
            half4 frag(Varyings input) : SV_Target
            {
                ...
                // float rawDepth = SAMPLE_TEXTURE2D_X(_MaskDepthRT, sampler_MaskDepthRT, screenUV);
